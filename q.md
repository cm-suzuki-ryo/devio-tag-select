...
|--------|--------|------|----------|------|----------|
| **Nova Lite** | 0.16円 | 95点 | 7秒 | **最高コスパ** | 環境変数対応 |
| **GPT-OSS 20B** | 0.43円 | 98点 | 11秒 | 高精度 | 環境変数対応 |
| **Claude Haiku 4.5** | 0.56円 | 95点 | 9秒 | バランス良好 | 環境変数対応 |
...
#### テスト環境
- **記事**: cursor-2-0（9,517文字の長文記事）
- **処理**: 要約作成 → MeCab処理 → 200タグ絞り込み → LLM評価
- **Docker**: 全3モデルで正常動作確認済み
